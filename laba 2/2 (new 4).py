class Pole:
    ...
    def __init__(self, size):
        ...
        # Переменная для проверки первой комбинации
        self.a = 0
    ...
    def movements(self, down, right):
        ...
        for i in moves:
            ...
            if (down + i[0]) >= 0 and (right + i[1]) >= 0 and (down + i[0]) < self.size and (right + i[1]) < self.size:
    ...
    def figures(self, n: int, k: int, coords_k: list):
        ...
        def counting(figures: list, coords_of_movement: list, count: int, start_down, start_right) -> int:
            """
            ...
            if len(figures) == n:
                ...
                if self.a == 0:
                    self.print_first_combination(figures)
                    self.a = 1
    ...
    def print_first_combination(self, f_combination) -> None:
        """
        ...
        for i in f_combination:
            first_combination_movements += self.movements(i[0], i[1])
        pole = []

        # Создание поля
        for i in range(0, self.size):
            pole.append(['0']*self.size)
